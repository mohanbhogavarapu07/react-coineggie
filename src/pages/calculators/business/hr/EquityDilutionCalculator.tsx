...
import { DollarSign, PieChartIcon, TrendingUp, Users, Calculator, Scale, Percent } from "lucide-react";
        ...
        <Card className="calculator-card">
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <Label htmlFor="currentShares" className="text-sm font-medium mb-1 block">
                  Current Shares
                </Label>
                <TooltipProvider>
                  <Tooltip>
              ...
              <div>
                <Label htmlFor="newInvestment" className="text-sm font-medium mb-1 block">
                  New Investment (₹)
                </Label>
                <TooltipProvider>
                  <Tooltip>
