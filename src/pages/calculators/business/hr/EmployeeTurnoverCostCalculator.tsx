...
import { Calculator, TrendingUp, DollarSign, Percent, Users, PieChart, Briefcase, Clock, AlertTriangle, Scale } from "lucide-react";
        ...
        <Card className="calculator-card">
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <Label htmlFor="annualSalary" className="text-sm font-medium mb-1 block">
              ...
              <div>
                <Label htmlFor="turnoverRate" className="text-sm font-medium mb-1 block">
              ...
              <div>
                <Label htmlFor="employees" className="text-sm font-medium mb-1 block">
                  Number of Employees
                </Label>
                <Input
                  id="employees"
