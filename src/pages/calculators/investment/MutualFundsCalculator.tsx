...
const MutualFundsCalculator: React.FC = () => {
  ...
  return (
    <CalculatorLayout title="Mutual Funds Calculator" description="Calculate and analyze your mutual fund investments" icon={<Calculator className="h-6 w-6" />} activeTab="investment">
